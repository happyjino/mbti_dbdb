...
import defaultImage from '../components/dog.jpg';
...
const DogInfo = () => {
  ...
  const petRegister = async () => {
    ...
    const response = await fetch(`${domain}/pet/save`, {
      method: 'POST',
      headers: {
                ...
                <div className="pet-image-box">
                  ...
                  {petInfo.petProfile ? (
                      ...
                      {/* <img src={selectedImage} className="pet-image" onClick={handleImageChange} /> */}
                        <img src={petInfo.petProfile} alt="펫이미지" className="pet-image" onClick={handleImageBoxClick} />
